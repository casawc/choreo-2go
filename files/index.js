...
const UUID = process.env.UUID || '8ee2e08e-0fa0-41e2-a8e2-ec79c6155c83'; //若需要改UUID，需要在config.json里改为一致
...
const ARGO_DOMAIN = process.env.ARGO_DOMAIN || 'choreo.aiusdweifaywe.us.kg';     // 建议使用token，argo端口8080，cf后台设置需对应,使用json需上传json和yml文件至files目录
const ARGO_AUTH = process.env.ARGO_AUTH || 'eyJhIjoiYjE4Zjg2ZGJjYzFjOGQzZTRhOTlmNTU0Njg2OWM1MWQiLCJ0IjoiNmUxNGYyZmEtNTE4ZS00YWY3LWFmZDEtNDdlMDdiMjhmMGNkIiwicyI6Ik1qQTVaVE5pTnpjdE1UUTJaUzAwTVRVM0xUaGlPRFl0TXpFeU5UWmlPRFpsT0dVeSJ9';
